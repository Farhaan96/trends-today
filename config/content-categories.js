...
module.exports = {
  ...
  categories: {
    ...
    science: {
      ...
      slug: 'science',
      description:
        'Breakthrough discoveries, quantum physics, and scientific mysteries that challenge our understanding',
      keywords: [
      ...
      aiImageStyle:
        'abstract scientific visualization, cosmic nebula, molecular structures, laboratory aesthetics, quantum particles',
    ...
    culture: {
      ...
      slug: 'culture',
      description:
        'Cultural phenomena, generational shifts, and social trends reshaping our world',
      keywords: [
        'gen z culture shift',
        'viral trend analysis',
        'cultural phenomenon 2025',
      ...
      aiImageStyle:
        'cultural mosaic, social connection visualization, diverse representation, modern urban aesthetics, trending symbols',
      curiosityGapHeadlines: [
    ...
    psychology: {
      ...
      slug: 'psychology',
      description:
        'Human behavior, mental wellness, and the fascinating science of the mind',
      keywords: [
        'psychology behind behavior',
        'mental health breakthrough',
        'cognitive science discovery',
      ...
      aiImageStyle:
        'abstract mind visualization, neural pathways, emotional spectrum, consciousness representation, surreal mental landscape',
      curiosityGapHeadlines: [
    ...
    technology: {
      ...
      slug: 'technology',
      description:
        'Tech innovations, AI developments, and the digital transformation of everything',
      keywords: [
      ...
      aiImageStyle:
        'futuristic tech visualization, circuit board abstract, AI neural networks, innovation flow, cyberpunk aesthetics',
      curiosityGapHeadlines: [
    ...
    health: {
      ...
      slug: 'health',
      description:
        'Medical breakthroughs, wellness discoveries, and evidence-based health insights',
      keywords: [
        'health benefits discovery',
        'medical breakthrough 2025',
        'wellness trend science',
      ...
      aiImageStyle:
        'wellness visualization, organic flowing forms, medical innovation, healthy lifestyle abstract, vitality representation',
      curiosityGapHeadlines: [
    ...
    space: {
      ...
      slug: 'space',
      description:
        'Space exploration, astronomical discoveries, and the mysteries of the cosmos',
      keywords: [
        'NASA discovery announcement',
        'James Webb telescope findings',
        'SpaceX mission update',
        'exoplanet discovery 2025',
      ...
      aiImageStyle:
        'cosmic nebula visualization, deep space imagery, planetary surfaces, galaxy formations, astronomical phenomena',
      curiosityGapHeadlines: [
  ...
  imagePromptTemplates: {
    science:
      'abstract scientific visualization, glowing particles, cosmic nebula, laboratory aesthetics, futuristic research, depth of field',
    psychology:
      'abstract mind concept, neural pathways, emotional spectrum, consciousness visualization, surreal mental landscape',
    health:
      'wellness visualization, organic flowing forms, vitality abstract, healing energy, balanced lifestyle imagery',
    culture:
      'cultural mosaic, diverse patterns, social connection web, cultural symbols abstract, unity in diversity',
    environment:
      'nature abstract, climate visualization, earth from space, renewable energy flow, ecological balance',
    mystery:
      'enigmatic atmosphere, shadowy depths, mysterious portal, unknown dimensions, cryptic symbols',
    future:
      'futuristic cityscape, neon geometry, time travel visualization, technological singularity, cyberpunk aesthetic',
    history:
      'ancient ruins abstract, time layers, historical artifacts collage, vintage texture overlay, archaeological dig site',
    lifestyle:
      'modern minimalist, lifestyle montage, urban living abstract, work-life balance visualization, trendy aesthetics',
    technology:
      'digital matrix, circuit board abstract, AI visualization, quantum computing representation, innovation flow',
  },
