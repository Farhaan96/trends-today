...
// Comprehensive unique image mapping with diverse themes
const comprehensiveImageMapping = {
  ...
  'ai-agents-revolution-13-billion-market-taking-over-2025': {
    ...
    alt: 'Robotic automation systems and AI workforce transformation'
  },
  'ai-agents-workplace-productivity-2025': {
    url: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&h=630&fit=crop',
    alt: 'Modern office with AI-powered productivity tools and team collaboration'
  },
  ...
  // Science articles - diverse scientific imagery
...
// Alternative high-quality image sets for each category
const categoryImageSets = {
  technology: [
    'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=1200&h=630&fit=crop', // AI/Robotics
    'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&h=630&fit=crop', // Office/Productivity
    'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&h=630&fit=crop', // Innovation/Tech
    'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=1200&h=630&fit=crop', // Legal/Tech
    'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=1200&h=630&fit=crop'  // Quantum/Advanced
  ],
  science: [
...
function getUniqueImageForArticle(filename, category) {
  ...
  if (comprehensiveImageMapping[filename]) {
    return comprehensiveImageMapping[filename];
  }

  // If no specific mapping, get a unique image from the category pool
  const categoryImages = categoryImageSets[category] || categoryImageSets.technology;
...
async function main() {
  console.log('🎨 Starting comprehensive image diversification...\n');
  ...
  if (results.processed > 0) {
    console.log('\n🎉 Comprehensive image diversification complete!');
    console.log('Your articles now have much more diverse and unique imagery.');
  }
}
