...
// Completely unique image mapping - no duplicates allowed
const uniqueImageMapping = {
  ...
  // Science articles - unique scientific imagery
  ...
  // Psychology articles - completely different psychological themes
...
async function main() {
  console.log('🎨 Starting comprehensive image duplicate fix...\n');
