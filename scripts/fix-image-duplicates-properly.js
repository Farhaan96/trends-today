...
// Completely unique image mapping - NO DUPLICATES
const uniqueImageMapping = {
  ...
  // Science articles - UNIQUE scientific imagery (different from psychology)
  ...
  // Psychology articles - DIFFERENT psychological themes (not the same brain image)
