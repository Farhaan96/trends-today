...
class DalleClient {
  ...
  async generateBlogImage(articleTitle, category, description) {
    ...
    const categoryPrompts = {
      technology:
        'futuristic technology, modern digital interface, sleek design, professional lighting',
      psychology:
        'abstract brain visualization, neural networks, psychology concept, soft lighting',
      science:
        'scientific laboratory, DNA helix, molecular structures, clean white background',
      health:
        'medical equipment, healthcare technology, clean modern design, professional',
      space:
        'cosmic space, planets, stars, nebula, astronomical phenomena, deep space',
      culture:
        'artistic cultural elements, modern design, vibrant colors, contemporary style',
    };

    const basePrompt =
      categoryPrompts[category] ||
      'professional modern design, clean background';
