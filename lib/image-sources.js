...
class ImageSourceManager {
  constructor(config = {}) {
    ...
    this.shutterStockApiKey = config.shutterStockApiKey || process.env.SHUTTERSTOCK_API_KEY;
    ...
    this.curatedImages = {
      ...
      'iphone-16-pro-max-titanium-hero.jpg': {
        primary: 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
      ...
      'iphone-16-pro-max-camera-system.jpg': {
        primary: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
      ...
      'iphone-16-pro-max-apple-intelligence.jpg': {
        primary: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
      ...
      'iphone-16-pro-max-a18-bionic.jpg': {
        primary: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
      ...
      'iphone-16-pro-max-battery-life.jpg': {
        primary: 'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
      ...
      'iphone-15-pro-max-display.jpg': {
        primary: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
          'https://images.unsplash.com/photo-1558618666-fcd25d85cd64?w=1200&h=800&fit=crop&q=90'
        ],
      ...
      'iphone-15-pro-max-usbc.jpg': {
        primary: 'https://images.unsplash.com/photo-1558618666-fcd25d85cd64?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
      ...
      'performance-benchmarks.jpg': {
        primary: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
      ...
      'apple-event-how-to-watch.jpg': {
        primary: 'https://images.unsplash.com/photo-1531498860502-7c67cf02f657?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
      ...
      'apple-watch-airpods-2025.jpg': {
        primary: 'https://images.unsplash.com/photo-1434493789847-2f02dc6ca35d?w=1200&h=800&fit=crop&q=90',
        fallbacks: [
  ...
  async getImageUrl(filename, options = {}) {
    ...
    if (this.unsplashAccessKey && this.canMakeRequest('unsplash') && searchQuery) {
      try {
        const unsplashUrl = await this.searchUnsplash(searchQuery, dimensions, quality);
        if (unsplashUrl) {
    ...
    if (this.canMakeRequest('manufacturer')) {
      try {
        const manufacturerUrl = await this.searchManufacturerApi(filename, category);
        if (manufacturerUrl) {
        ...
        console.log(`Manufacturer API failed for ${filename}: ${error.message}`);
      }
    }
  ...
  getIntelligentFallback(filename, searchQuery = '', dimensions) {
    ...
    // Samsung fallbacks  
    if (fn.includes('samsung') || fn.includes('galaxy') || query.includes('samsung')) {
    ...
    if (fn.includes('pixel') || fn.includes('google') || query.includes('pixel')) {
    ...
    // AI/Tech fallbacks
    if (fn.includes('ai') || fn.includes('intelligence') || query.includes('ai')) {
    ...
    if (fn.includes('performance') || fn.includes('benchmark') || query.includes('benchmark')) {
