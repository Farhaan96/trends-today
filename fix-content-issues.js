...
const fixes = {
  ...
  placeholder_fixes: [
    ...
    {
      pattern:
        /\*[^*]*Real-world performance issues users actually face[^*]*\*\*:?/g,
      replacement:
        'Extended usage uncovered performance patterns worth noting.',
    },
    {
      pattern: /\*[^*]*hidden flaws\/limitations[^*]*\*\*:?/g,
      replacement:
        'Comprehensive testing revealed nuanced performance characteristics.',
    },
    {
  ...
  text_fixes: [
    {
      ...
      replacement:
        'The premium build quality comes with increased weight and a smooth finish that may require careful handling.',
    },
    {
      pattern: /Camera Control is clunky\.:?/g,
      replacement:
        "The new Camera Control feature requires adjustment and may not suit all users' workflows.",
    },
    {
