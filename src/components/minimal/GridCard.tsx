  ...
  return (
    <article>
      ...
      <div className="mt-2 text-sm text-gray-500">
        <span className="uppercase tracking-wide text-[var(--color-primary)] font-semibold">{category}</span>
      ...
      <div className="mt-3 relative w-full aspect-[16/9] bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-md overflow-hidden">
        {img ? (
          <Image src={img} alt={title} fill className="object-cover" sizes="(max-width: 768px) 100vw, 30vw" />
        ) : (
