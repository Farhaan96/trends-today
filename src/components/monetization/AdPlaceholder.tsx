...
interface AdPlaceholderProps {
  adSlot: string;
  format?: 'banner' | 'rectangle' | 'leaderboard' | 'skyscraper' | 'mobile-banner';
  className?: string;
  label?: string;
}
...
export default function AdPlaceholder({
  ...
  return (
    <div className={`ad-container ${className}`}>
      ...
      <div 
        ref={adRef}
        className="flex items-center justify-center border border-gray-200 rounded bg-gray-50 text-gray-400 text-sm"
