          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 xl:col-span-1">
              ...
              <p className="text-gray-300 text-base">
                Your trusted source for in-depth tech reviews, product
                comparisons, and comprehensive buying guides.
              </p>

              {/* Social Media Links */}
              <div className="flex space-x-4">
                <a
                  href="https://twitter.com/trendstoday"
                ...
                <a
                  href="https://facebook.com/trendstoday"
                ...
                <a
                  href="https://youtube.com/@trendstoday"
                ...
                <a
                  href="https://linkedin.com/company/trends-today"
                ...
                <div className="mt-12 md:mt-0">
                  ...
                  <ul className="mt-4 space-y-4">
                    <li>
                      <Link
                        href="/subscribe"
                        className="text-base text-purple-300 hover:text-white font-medium"
                      >
                        Trends Today Pro ✨
                      </Link>
                    </li>
            ...
            <div className="bg-white/10 backdrop-blur rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-gray-300">
                  ...
                  Trends Today participates in various affiliate marketing
                  programs. We may earn commissions from purchases made through
                  links on our site at no additional cost to you. This helps
                  support our independent testing and reviews.
                  <Link
                    href="/affiliate-disclosure"
