    ...
    <div className="my-8 p-6 bg-gray-50 rounded-lg border">
      ...
      <div className="mt-4 space-y-2">
        <p className="text-sm text-gray-600">
          <strong>Scale Challenge:</strong> The observable universe contains
          approximately
          <strong className="text-purple-600"> 3.5×10¹²⁴ bits</strong> of
          information according to Erin Choban's astrophysical calculations.
        </p>
        <p className="text-sm text-gray-600">
          This vastly exceeds current technological storage capabilities by over
          <strong> 100 orders of magnitude</strong>, highlighting the
          computational challenge of simulating reality at full fidelity.
        </p>
      </div>
    </div>
  );
