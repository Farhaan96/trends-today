...
export const contentDatabase = [
  // Reviews
  {
    ...
    excerpt:
      'Our comprehensive review of the iPhone 15 Pro covers design, performance, camera quality, and value proposition.',
  ...
  },
  {
    ...
    excerpt:
      "Samsung's flagship delivers exceptional performance, camera capabilities, and productivity features.",
  ...
  },
  {
    ...
    excerpt:
      "Google's latest flagship showcases the future of AI-powered mobile photography.",
  ...
  },
  {
    ...
    excerpt:
      "Apple's M3-powered MacBook Air delivers impressive performance in an ultra-portable package.",
  ...
  // Comparisons
  {
    ...
    excerpt:
      "Head-to-head comparison of Apple and Samsung's latest flagships across all key metrics.",
  ...
  },
  {
    ...
    excerpt:
      'Comprehensive comparison to help you choose between macOS and Windows laptops.',
  ...
  // Buying Guides
  {
    ...
    excerpt:
      'Our expert picks for the best smartphones across all price ranges in 2025.',
  ...
  },
  {
    ...
    excerpt:
      'Top laptop picks for gaming, productivity, students, and professionals.',
  ...
  },
  {
    ...
    excerpt:
      'Complete guide to the best headphones and earbuds for every use case and budget.',
...
export function generateClusterLinks(currentUrl: string): InternalLink[] {
  ...
  topicClusters.forEach((cluster) => {
    ...
    // If current page is a cluster page, link to pillar and related pages
      ...
      const currentPage = cluster.clusterPages.find(
...
export function addInternalLinksToContent(
  ...
  const availableLinks = generateInternalLinks(
    content,
    currentUrl,
    maxTotalLinks * 2
  );
  ...
  paragraphs.forEach((paragraph, index) => {
    ...
    availableLinks.forEach((link) => {
      if (
        totalLinksAdded >= maxTotalLinks ||
        linksInParagraph >= maxLinksPerParagraph
      ) {
        return;
      }
      ...
      anchorVariations.forEach((anchor) => {
        if (usedAnchors.has(anchor.toLowerCase()) && avoidOverOptimization)
          return;
