...
export const metadata: Metadata = {
  ...
  description: 'Meet the experienced technology journalists and experts behind Trends Today\'s in-depth reviews and analysis. Our team brings decades of combined expertise in mobile technology, audio, computing, and smart home devices.',
  openGraph: {
    title: 'Editorial Team - Technology Experts at Trends Today',
    description: 'Meet our team of experienced technology journalists and industry experts.',
    type: 'website',
  },
};
...
export default function AuthorsPage() {
  ...
  const totalReviews = authors.reduce((sum, author) => sum + author.reviewCount, 0);
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <section className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Why Trust Our Reviews?</h2>
