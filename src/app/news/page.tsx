    ...
    <main className="max-w-7xl mx-auto px-4 py-8">
      ...
      <header className="mb-12 text-center">
        ...
        <p className="text-xl text-gray-900 max-w-3xl mx-auto">
          Breaking news, product launches, and industry insights from the world
          of technology. Stay ahead with the latest developments.
        </p>
      </header>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-900">
                    <span>
                      {(typeof article.frontmatter.author === 'string'
                        ? article.frontmatter.author
                        : article.frontmatter.author?.name) || 'Editorial Team'}
                    </span>
                    <time dateTime={article.frontmatter.publishedAt}>
                      {article.frontmatter.publishedAt
                        ? new Date(
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          {recentArticles.map((article, index) => (
            <article
              key={article.slug}
              className={`flex gap-6 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'} rounded-lg p-6 hover:shadow-md transition-shadow`}
            >
              {article.frontmatter.image && (
      ...
      <section className="bg-blue-600 text-white rounded-lg p-8 text-center">
        ...
        <p className="text-blue-200 mb-6">
          Get the latest tech news delivered to your inbox. Join 50,000+
          readers.
        </p>
