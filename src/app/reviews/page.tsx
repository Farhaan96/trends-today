...
export default async function ReviewsPage({
  ...
  const reviewsByCategory = filtered.reduce(
    (acc, review) => {
      const category =
        typeof review.frontmatter.category === 'string'
  ...
  const featuredReviews = filtered.filter(
    ...
    <main className="max-w-7xl mx-auto px-4 py-8">
      ...
      <header className="mb-12 text-center">
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
          {activeCategory
            ? `${activeCategory.replace('-', ' ')} Reviews`
            : 'Tech Reviews'}
        </h1>
        <p className="text-xl text-gray-800 max-w-3xl mx-auto">
          Expert reviews and analysis of the latest technology products. We test
          everything so you can make informed decisions.
        </p>
      </header>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-900">
                    ...
                    <time dateTime={review.frontmatter.publishedAt}>
                      {review.frontmatter.publishedAt
                        ? new Date(
                            review.frontmatter.publishedAt
                          ).toLocaleDateString()
                        : 'Recently'}
          ...
          {recentReviews.map((review) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between text-sm text-gray-900">
                  <span>
                    {(typeof review.frontmatter.author === 'string'
                      ? review.frontmatter.author
                      : review.frontmatter.author?.name) || 'Editorial Team'}
                  </span>
                  <time dateTime={review.frontmatter.publishedAt}>
                    {review.frontmatter.publishedAt
                      ? new Date(
