        ...
        messages: [
          {
            role: 'system',
            content:
              'You are a tech research assistant. Provide brief, factual information about technology products and trends.',
          },
          {
            role: 'user',
            content:
              'What are the latest smartphone releases in 2025? Just give me 3 key recent releases with brief details.',
          },
        ],
        max_tokens: 150,
        temperature: 0.2,
