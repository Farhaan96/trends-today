...
const mockResults = [
  {
    ...
    excerpt: 'After two weeks of intensive testing, the iPhone 15 Pro Max delivers exceptional performance with its A17 Pro chip and impressive camera system.',
  ...
  },
  {
    ...
    type: 'guide' as const,
    excerpt: 'Comprehensive buying guide covering the top laptops for students across different budgets, from budget-friendly options to premium ultrabooks.',
  ...
  },
  {
    ...
    excerpt: 'Head-to-head comparison of the flagship smartphones from Apple and Samsung, covering performance, camera, battery life, and value.',
  ...
  },
  {
    ...
    type: 'review' as const,
    excerpt: 'In-depth review of Sony\'s flagship noise-cancelling headphones with improved comfort, battery life, and exceptional sound quality.',
  ...
  },
  {
    ...
    type: 'comparison' as const,
    excerpt: 'Detailed comparison between Apple\'s latest MacBook Air and Dell\'s premium ultrabook, focusing on performance, design, and value.',
