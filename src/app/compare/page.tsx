    ...
    <main className="max-w-7xl mx-auto px-4 py-8">
      ...
      <header className="mb-12 text-center">
        ...
        <p className="text-xl text-gray-900 max-w-3xl mx-auto">
          Make informed decisions with our detailed product comparisons. We
          break down specs, features, and value to help you choose the perfect
          tech.
        </p>
      </header>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {comparisonCategories.map((category, index) => (
            ...
            >
              <div
                className={`${category.color} h-20 rounded-t-xl flex items-center justify-center`}
              >
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-900">
                    <span>
                      Updated{' '}
                      {comparison.frontmatter.publishedAt
                        ? new Date(
                            comparison.frontmatter.publishedAt
                          ).toLocaleDateString()
                        : 'Recently'}
