...
import { AffiliateProvider, PriceData, ProductComparison } from '@/types/monetization';
...
export const samplePriceData: PriceData[] = [
  {
    ...
    affiliateUrl: 'https://amazon.com/dp/B0CHX2F5QT?tag=trendstoday-20&linkCode=ogi&th=1&psc=1',
  ...
  },
  {
    ...
    inStock: true,
    lastUpdated: new Date().toISOString(),
    affiliateUrl: 'https://bestbuy.7tiv.net/c/1234567/615614/10014?u=https://www.bestbuy.com/site/apple-iphone-15-pro',
  ...
  },
  {
    ...
    inStock: true,
    lastUpdated: new Date().toISOString(),
    affiliateUrl: 'https://goto.target.com/c/1234567/81938/2092?u=https://www.target.com/p/apple-iphone-15-pro',
  ...
  },
  {
    ...
    inStock: true,
    lastUpdated: new Date().toISOString(),
    affiliateUrl: 'https://click.linksynergy.com/link?id=abcd1234&offerid=123456.789&type=15&murl=https%3A%2F%2Fwww.newegg.com%2Fp%2F2WC-000M-00001',
    shipping: 'Free shipping',
  ...
  },
  {
    ...
    inStock: false,
    lastUpdated: new Date().toISOString(),
    affiliateUrl: 'https://www.bhphotovideo.com/c/product/1740718-REG/apple_mtq03ll_a_iphone_15_pro_128gb.html/BI/12345/KBID/67890',
...
export const sampleProductComparisons: ProductComparison[] = [
  {
    ...
    affiliateLinks: {
      [AffiliateProvider.AMAZON]: 'https://amazon.com/dp/B0CMDWC436?tag=trendstoday-20&linkCode=ogi&th=1&psc=1',
      [AffiliateProvider.BESTBUY]: 'https://bestbuy.7tiv.net/c/1234567/615614/10014?u=https://www.bestbuy.com/site/samsung-galaxy-s24',
      [AffiliateProvider.TARGET]: 'https://goto.target.com/c/1234567/81938/2092?u=https://www.target.com/p/samsung-galaxy-s24'
    },
  ...
  },
  {
    ...
    affiliateLinks: {
      [AffiliateProvider.AMAZON]: 'https://amazon.com/dp/B0CHX1W2V3?tag=trendstoday-20&linkCode=ogi&th=1&psc=1',
      [AffiliateProvider.BESTBUY]: 'https://bestbuy.7tiv.net/c/1234567/615614/10014?u=https://www.bestbuy.com/site/apple-iphone-15',
      [AffiliateProvider.TARGET]: 'https://goto.target.com/c/1234567/81938/2092?u=https://www.target.com/p/apple-iphone-15'
    },
  ...
  },
  {
    ...
    affiliateLinks: {
      [AffiliateProvider.AMAZON]: 'https://amazon.com/dp/B0CGR4F4JC?tag=trendstoday-20&linkCode=ogi&th=1&psc=1',
      [AffiliateProvider.BESTBUY]: 'https://bestbuy.7tiv.net/c/1234567/615614/10014?u=https://www.bestbuy.com/site/google-pixel-8-pro',
      [AffiliateProvider.TARGET]: 'https://goto.target.com/c/1234567/81938/2092?u=https://www.target.com/p/google-pixel-8-pro'
    },
  ...
  },
  {
    ...
    affiliateLinks: {
      [AffiliateProvider.AMAZON]: 'https://amazon.com/dp/B0CQV7J2K4?tag=trendstoday-20&linkCode=ogi&th=1&psc=1',
      [AffiliateProvider.NEWEGG]: 'https://click.linksynergy.com/link?id=abcd1234&offerid=123456.789&type=15&murl=https%3A%2F%2Fwww.newegg.com%2Fp%2F2WC-001X-00002'
    },
...
export const affiliateConfig = {
  ...
  [AffiliateProvider.COMMISSION_JUNCTION]: {
    ...
    trackingParams: 'id={publisherId}&offerid={offerId}&type=15&murl={productUrl}'
  },
  [AffiliateProvider.NEWEGG]: {
    publisherId: 'abcd1234',
    baseUrl: 'https://click.linksynergy.com/link',
    trackingParams: 'id={publisherId}&offerid=123456.789&type=15&murl={productUrl}'
  },
