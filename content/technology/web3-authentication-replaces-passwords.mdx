...
\***\*85%** of people reuse passwords**. Average breach costs \*\***$4.

45 million\*\*\*\*. Passkeys eliminate both problems.
...
3. Private key stays on device (never transmitted)
   **4. B**iometric unlocks private key locally
...
2. [Google Security Blog - Passkey Statistics](https://security.

googleblog. com/) - **800M** accounts, **2. 3. [Bitwarden - World Password Day Survey](https://bitwarden.com/resources/world-password-day-2024/) - **550%** growth, **85%\*\* reuse 4. [IBM - Data Breach Report 2024](https://www.

ibm. com/security/data-breach) - \*\*$4. 5. [NIST - 2025 Authentication Guidelines](https://pages.nist.gov/800-63-4/) - Federal requirements
