...
highlights:
  - 'Anthropic pays $1.5 billion for using pirated books to train Claude AI. 500,000 works at $3,000 each. Largest copyright payout in U.S. history.'
  - 'The artificial intelligence industry just witnessed its most expensive wake-up call.'
  - 'Anthropic, the company behind Claude AI, agreed to pay $1.5 billion to settle copyright claims from authors whose pirated books were used to train their AI model.'
