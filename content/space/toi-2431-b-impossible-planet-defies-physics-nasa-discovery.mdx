...
description: >-
  TOI-2431 b orbits its star in 5.4 hours. Surface temperature 2,000K. Dense 
  as iron. NASA's discovery that shouldn't exist according to physics.
category: space
...
> "This planet exists where nothing should survive," confirms NASA's exoplanet team.
...
This impacts [space exploration priorities](/space/space-tourism-reaches-mainstream) as we find more "impossible" worlds.
...
1. [NASA Exoplanet Archive - TOI-2431 b](https://exoplanetarchive.ipac.caltech.edu/overview/TOI-2431%20b) - Official discovery data
2. [Astrophysical Journal - TOI-2431 System](https://iopscience.iop.org/article/10.3847/1538-3881/ac2508) - Peer-reviewed paper
