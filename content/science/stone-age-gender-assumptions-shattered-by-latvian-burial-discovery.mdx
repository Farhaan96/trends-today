...
**Burial 207**, a young girl genetically confirmed as female, contained the **largest collection of bifacial points** (sophisticated hunting weapons) ever discovered at Zvejnieki. These aren't decorative items. They required **advanced skill** to manufacture and use.
