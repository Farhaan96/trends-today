...
**Nature Communications** published 2025 research showing brain organoids develop **synaptic plasticity**, the strengthening of neural connections that underlies memory formation. These organoids activated learning genes and formed neural networks similar to developing human brains.
