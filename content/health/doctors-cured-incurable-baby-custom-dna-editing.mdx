---
title: "Doctors Cure 'Incurable' Baby With Custom CRISPR Edit"
description: >-
...
highlights:
  - 'Revolutionary CRISPR breakthrough saves infant with rare genetic liver disorder through personalized gene therapy, marking first custom DNA treatment for single patient'
  - 'Six months ago, an infant with carbamoyl phosphate synthetase 1 (CPS1) deficiency faced a death sentence.'
  - 'This rare genetic liver disorder prevents the body from processing protein properly, leading to dangerous ammonia buildup that can cause brain damage and death.'
