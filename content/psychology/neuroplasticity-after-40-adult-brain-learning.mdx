...
highlights:
  - 'Neuroplasticity research challenges aging myths with evidence of enhanced learning capacity, silent synapses, and cognitive gains well into middle age.'
  - 'For decades, neuroscience assumed the adult brain''s learning capacity peaked in youth and declined steadily thereafter.'
  - 'MIT neuroscientists discovered that 30% of synapses in the adult brain cortex are "silent" connections waiting to be activated for new learning.'
