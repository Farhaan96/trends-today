...
- Changed variable: choose topics by the configured evidence score rather than by daily output count.
...
- Guardrails: three usable sources, no unsupported claim, no placeholder image, passing build/QA, and no direct scheduled publishing.
